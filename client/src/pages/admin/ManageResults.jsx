...
import { FaArrowLeft, FaTrophy, FaMedal, FaAward, FaPlus } from 'react-icons/fa';
  ...
  const openModal = (result = null) => {
    if (result) {
      ...
      setForm({
        ...
        silver_winner: result.silver_winner || '',
        bronze_winner: result.bronze_winner || ''
      });
    } else {
      setEditing(null);
      setForm({
  ...
  return (
    <div>
      ...
      <div className="page-header">
        ...
        <p>Add, edit, and delete winners for each sport</p>
      </div>
        ...
        <table className="admin-table">
          <thead>
            <tr>
              ...
              <th>Category</th>
              <th>Gender</th>
              <th><FaTrophy /> 1st Place</th>
              <th><FaMedal /> 2nd Place</th>
              <th><FaAward /> 3rd Place</th>
              <th>Actions</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={result.id}>
                ...
                <td>
                  <div className="table-actions">
                    <button className="btn btn-secondary btn-sm" onClick={() => openModal(result)}>
                      Edit
                    </button>
                    <button className="btn btn-danger btn-sm" onClick={() => deleteResult(result.id)}>
                      Delete
                    </button>
                  </div>
                </td>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  {sports.map((sport) => (
                    <option key={sport.id} value={sport.id}>
                      {sport.name} ({sport.age_category_name} - {sport.gender})
                    </option>
                  ))}
                </select>
              </div>
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={form.gold_winner}
                  onChange={(e) => setForm({ ...form, gold_winner: e.target.value })}
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={form.silver_winner}
                  onChange={(e) => setForm({ ...form, silver_winner: e.target.value })}
              ...
              <div className="form-group">
                ...
                <input
                  type="text"
                  value={form.bronze_winner}
                  onChange={(e) => setForm({ ...form, bronze_winner: e.target.value })}
